...
import '../bloc/local_articles/local_articles/local_articles_bloc.dart';
import '../widgets/article_widget.dart';

class SavedArticlesView extends HookWidget {
  final Article? article;

  const SavedArticlesView({Key? key, this.article}) : super(key: key);
      ...
      return Center(
        child: SizedBox(
          ...
          child: Card(
            ...
            child: const Center(
              child: Text(
                'No hay articulos guardados aún',
                style:
